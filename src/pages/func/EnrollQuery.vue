<template>
    ...
    <a-row type="flex" align="middle">
      <a-col :span="3" :offset="1" style="text-align: right; padding-right: 10px"
        >选择批次</a-col
      >
      <a-col :span="6">
    ...
    <a-row type="flex" align="middle" style="margin-top: 10px">
      ...
      <a-col :span="3" style="padding-right: 10px">
        <a-tooltip>
          <template #title
            >将查询字段中包括输入框中文本的报名信息，可以输入学号、姓名、部门名称等</template
          >
          <question-outlined />
        </a-tooltip>
      </a-col>
    ...
    <a-modal v-model:visible="infoModalVisible" title="资料详情">
      <template #footer>
        <a-button key="ok" type="primary" @click="infoModalVisible = false"
          >确定</a-button
        >
      </template>
